...
\begin{rSection}{Work Experience}
    ...
    \begin{adjustwidth}{2em}{}
        \begin{rSubsection}{Data Science Engineer}{\em July 2021 - present}{}{}
            \item I am working on developing optimisation procedures that run on an IoT device to control
            distributed energy resources. This involves having to run forecasts in real time, solve them, process the output, and
            then have the control implemented on an external device.
        \end{rSubsection}
...
\begin{rSection}{Technologies/Programming Languages}
    ...
    Ansible, Vue, React, LISP, PHP, C, C++, SPSS, MATLAB, Haskell, Docker Swarm, and Kubernetes
\end{rSection}
